...
/*
 * $Id: protos.h,v 1.573 2010/03/06 23:14:57 hno Exp $
 *
 *
...
void storeAddVary(const char *store_url, const char *url, method_t * method, const cache_key * key, const char *etag, const char *vary, const char *vary_headers, const char *accept_encoding);
